...
% rbfbkp   -  Backpropagate gradient of error function for 2-layer network. 
...
% rbfhess  -  Evaluate the Hessian matrix for a multi-layer perceptron network. 
% rbfjacob -  Evaluate derivatives of network outputs with respect to inputs. 
% rbfpak   -  Combines all the parameters in an RBF network into one weights vector. 
% rbfprior -  Create Gaussian prior for rbf. 
% rbfsetbf -  Set basis functions of RBF from data. 
% rbfsetfw -  Set width basis functions of RBF. 
