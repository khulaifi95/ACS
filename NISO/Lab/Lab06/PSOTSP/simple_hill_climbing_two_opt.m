function [best_distance best_route] = simple_hill_climbing_two_opt(best_particle)
% randomsearch
...
[temp, best_route] = sort(best_particle);
best_cities_coordinates = inputcities(:,best_route);
best_distance = distanceTSP(best_cities_coordinates);
...
while (stuck==false)
    for i = 2 : num_cities-1
        for k = i+1 : num_cities - 1
            ...
            new_distance = distanceTSP(new_cities_coordinates);
