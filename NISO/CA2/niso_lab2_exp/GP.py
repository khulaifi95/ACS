...
def question_3(path, pop_size, time_budget):
    ...
    fitnesses = [fitness(translate_data_placeholder(parse_tool.print_sexp(population[i].translate_tree()), data_demention), path) for i in range(pop_size)]
    ...
    # best_of_run.print_tree()
    print("best individual is: ", translate_data_placeholder(parse_tool.print_sexp(best_of_run.translate_tree()), data_demention))
