/**
 * @version 2017-11-23
 * @author Manfred Kerber The class represents a bank customer by name, address, and telephone
 *         number.
 */
public class Customer {
   ...
   * 
   * @return The String with the customer information in a human readable form.
   */
  public String toString() {
    return getCustomerName() + " email: " + getAddress() + " [Tel: " + getTelephoneNumber() + "]";
  }
}
