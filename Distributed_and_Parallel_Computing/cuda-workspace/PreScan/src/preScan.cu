...
// 1. block scan + host
// 2. full scan + host
// 3. BCAO on block scan + host
// 4. BCAO on full scan + host
...
/**
 * 2-1 Host version of full preScan
 * 
 * Compute the serial full prefix scan on CPU.
 */


/**
 * 2-2 GPU version of full preScan
 * 
 * Compute the parallel full prefix scan on GPU.
 */


/**
 * 3-1 Host version of block preScan with BCAO
 * 
 * Compute the serial prefix scan in a block with BCAO on CPU.
 */


/**
 * 3-2 GPU version of block preScan with BCAO
 * 
 * Compute the parallel prefix scan in a block with BCAO on GPU.
 */

 
/**
 * 4-1 Host version of full preScan with BCAO ?
 * 
 * Compute the serial full prefix scan on CPU.
 */
...
/**
 * 4-2 GPU version of full preScan with BCAO 
 * 
 * Compute the parallel full prefix scan on GPU.
 */
