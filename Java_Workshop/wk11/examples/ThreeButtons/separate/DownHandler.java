 ...
 *  The class implements the DownHandler, that is, the handler for the
 *  event that the downButton is clicked.

 *  @version 2018-11-30
 *  @author Manfred Kerber
 *
 */
public class DownHandler implements EventHandler<MouseEvent> {
    /**
     ...
     */
    public DownHandler(Counter counter, Text text) {
     ...
     *  first to decrease the counter, and second to update the text
     *  accordingly.
